...
public class BidirectionalContentBinding {
    ...
    private static class ListContentBinding<E> implements ListChangeListener<E>, WeakListener {
        ...
        private final ObservableList<E> propertyRef1;
        private final ObservableList<E> propertyRef2;
        ...
        public void onChanged(Change<? extends E> change) {
            if (!updating) {
                final ObservableList<E> list1 = propertyRef1;
                final ObservableList<E> list2 = propertyRef2;
        ...
        public boolean equals(Object obj) {
            ...
            final Object propertyA1 = propertyRef1;
            final Object propertyA2 = propertyRef2;
            ...
            if (obj instanceof ListContentBinding) {
                ...
                final Object propertyB1 = otherBinding.propertyRef1;
                final Object propertyB2 = otherBinding.propertyRef2;
    ...
    private static class SetContentBinding<E> implements SetChangeListener<E>, WeakListener {
        ...
        private final ObservableSet<E> propertyRef1;
        private final ObservableSet<E> propertyRef2;
        ...
        public void onChanged(Change<? extends E> change) {
            if (!updating) {
                final ObservableSet<E> set1 = propertyRef1;
                final ObservableSet<E> set2 = propertyRef2;
    ...
    private static class MapContentBinding<K, V> implements MapChangeListener<K, V>, WeakListener {
        ...
        private final ObservableMap<K, V> propertyRef1;
        private final ObservableMap<K, V> propertyRef2;
        ...
        public void onChanged(Change<? extends K, ? extends V> change) {
            if (!updating) {
                final ObservableMap<K, V> map1 = propertyRef1;
                final ObservableMap<K, V> map2 = propertyRef2;
