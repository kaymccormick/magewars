        ...
        protected Generic<T> addListener(InvalidationListener listener) {
            if (invalidationListeners == null) {
                ...
                if (locked) {
                    ...
                    InvalidationListener[] copy = new InvalidationListener[newCapacity];
                    System.arraycopy(invalidationListeners, 0, copy, 0, Math.min(invalidationListeners.length, newCapacity));
                    invalidationListeners = copy;
        ...
        protected ExpressionHelper<T> addListener(ChangeListener<? super T> listener) {
            if (changeListeners == null) {
                ...
                if (locked) {
                    ...
                    ChangeListener[] copy = new ChangeListener[newCapacity];
                    System.arraycopy(changeListeners, 0, copy, 0, Math.min(changeListeners.length, newCapacity));
                    changeListeners = copy;
