...
public final class Bindings {
    ...
    private static class ShortCircuitAndInvalidator implements InvalidationListener {
        ...
        private final BooleanAndBinding ref;
        ...
        public void invalidated(Observable observable) {
            final BooleanAndBinding binding = ref;
            if (binding == null) {
    ...
    private static class ShortCircuitOrInvalidator implements InvalidationListener {
        ...
        private final BooleanOrBinding ref;
        ...
        @Override
        public void invalidated(Observable observable) {
            final BooleanOrBinding binding = ref;
            if (binding == null) {
                observable.removeListener(this);
            } else {
                // short circuit invalidation. This BooleanBinding becomes
     ...
     * the {@code StringExpression}.
     * <p>
     * See {@code java.us.heptet.magewars.util.Formatter} for formatting rules.
     * 
     * @param format
