...
public class PlatformLogger {
    ...
    public static enum Level {
        ...
        static Level valueOf(int level) {
            ...
            int i = binarySearch(LEVEL_VALUES, 0, LEVEL_VALUES.length - 2, level);
    ...
    public static synchronized PlatformLogger getLogger(String name) {
        ...
        PlatformLogger ref = loggers.get(name);
        if (ref != null) {
            log = ref;
        }
        if (log == null) {
    ...
    public static synchronized void redirectPlatformLoggers() {
        ...
        for (Map.Entry<String, PlatformLogger> entry : loggers.entrySet()) {
            PlatformLogger ref = entry.getValue();
            PlatformLogger plog = ref;
            if (plog != null) {
    ...
    private void redirectToJavaLoggerProxy() {
        DefaultLoggerProxy lp = (DefaultLoggerProxy)this.loggerProxy;
