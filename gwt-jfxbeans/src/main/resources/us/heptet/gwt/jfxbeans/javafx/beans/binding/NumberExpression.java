...
public interface NumberExpression extends ObservableNumberValue {
     ...
     * {@code java.us.heptet.magewars.util.Formatter} for formatting rules.
     * 
     * @param format
     ...
     * the passed in {@code Locale}. See {@code java.us.heptet.magewars.util.Formatter} for
     * formatting rules. See {@code java.us.heptet.magewars.util.Locale} for details on
     * {@code Locale}.
     * 
     * @param format
     *            the formatting {@code String}
